...
```
postman-combine --api-key YOUR_API_KEY --ws-id WORKSPACE_ID -c
```
...
```
postman-combine --api-key YOUR_API_KEY --ws-id WORKSPACE_ID --timeout 300 --use-date --output-folder collections --merged-col-name merged_collection.json --codify-names
```
